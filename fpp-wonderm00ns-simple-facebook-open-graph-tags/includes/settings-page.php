...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	if ( isset($_POST['action']) ) {
		if (trim($_POST['action'])=='save') {
			...
			$usersettings['fb_image_use_cover']= 				intval(webdados_fb_open_graph_post('fb_image_use_cover'));
							...
							<tr>
								...
								<tr class="fb_image_options">
									...
									<td>
										...
										<div>
											3) <input type="checkbox" name="fb_image_use_cover" id="fb_image_use_cover" value="1" <?php echo (intval($fb_image_use_cover)==1 ? ' checked="checked"' : ''); ?>/>
											<?php _e('If it doesn\'t exist, use the cover image from the post/page content', 'wd-fb-og');?>
										</div>
										<div>
											4) <input type="checkbox" name="fb_image_use_content" id="fb_image_use_content" value="1" <?php echo (intval($fb_image_use_content)==1 ? ' checked="checked"' : ''); ?>/>
											<?php _e('If it doesn\'t exist, use the first image from the post/page content', 'wd-fb-og');?>
										</div>
										<div>
											5) <input type="checkbox" name="fb_image_use_media" id="fb_image_use_media" value="1" <?php echo (intval($fb_image_use_media)==1 ? ' checked="checked"' : ''); ?>/>
											<?php _e('If it doesn\'t exist, use first image from the post/page media gallery', 'wd-fb-og');?>
										</div>
										<div>
											6) <input type="checkbox" name="fb_image_use_default" id="fb_image_use_default" value="1" <?php echo (intval($fb_image_use_default)==1 ? ' checked="checked"' : ''); ?>/>
